                    ...
                    {step === 'info' ? (
                        ...
                        >
                            <div className="text-center py-2">
                                ...
                                <p className="text-xs font-black text-[#FF5C8A] mt-1">
                            ...
                            <div className="flex justify-between gap-2 px-1">
                                {otp.map((digit, index) => (
                                    <div key={index} className="flex-1 max-w-[45px] aspect-square bg-[#F8FAFC] rounded-xl border-2 border-slate-100 shadow-inner overflow-hidden focus-within:border-[#FF5C8A] focus-within:ring-2 focus-within:ring-[#FF5C8A]/10 transition-all duration-200">
                                        <input
                            ...
                            <div className="pt-2 text-center">
                                <button 
                                    ...
                                    className="px-4 py-2 text-[10px] font-bold text-gray-400 uppercase tracking-widest hover:text-[#FF5C8A] transition-colors flex items-center justify-center gap-2 mx-auto"
                                >
